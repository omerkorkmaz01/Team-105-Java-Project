...
public class C05_SubstringOlusturma {
    ...
    */
    ...
    public static void main(String[] args) {
            ...
            kendiSubstringMethodumuz("Java",6,8); // Bitis indexi sinirlarin disinda
    ...
    public static void kendiSubstringMethodumuz(String input, int basIndexi, int bitIndexi) {
        ...
        if (basIndexi > bitIndexi) {
            ...
            // baslangic ve bitis indexilerine gore baslangic index'i dahil,
