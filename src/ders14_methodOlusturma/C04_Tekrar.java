...
public class C04_Tekrar {
    public static void main(String[] args) {
        ...
        System.out.println(C02_StringConcete.birlestirMethodu(c, d)); // Nasil yani
        ...
        System.out.println(C03_StringTerseCevirme.stringiTerseCevir("Bu cumleyi terse cevir"));
