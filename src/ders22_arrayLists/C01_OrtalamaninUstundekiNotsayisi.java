...
public class C01_OrtalamaninUstundekiNotsayisi {
    ...
    public static void main(String[] args) {
        ...
        // Ogretmen 100'den buyuk bir sayi girdiginizde bitirdiginde
        // Sinif sayisini, sinif ortalamasini va kac kisinin ortalamanin ustunde not aldıgını yazdirin
        ...
        System.out.println(" Girilen not sayisi : " + ogrenciSayisi +
                             "\nGirilen notlarin ortalamasi : " + sinifNotOrtalamasi +
                              "\nOrtalama ustunedeki not alan ogrenci sayisi : " + ortalamaUstundekiOgrenciSayisi);
