...
public class C02_ExplicitNarrowing {
    public static void main(String[] args) {
        ...
        /*
        genis data turundeki bir degeri dar data turundeki bir variable'a atamak isterseniz
        java sorumlulugu almanizi ister

        bu sorumlulugu almak icin cast edecegimiz deger'in onune () icersinde
        ...
        veya baskalsim olablir /int'i byte cevirirsek tekrar tekrar basa doner)
